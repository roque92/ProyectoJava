...
public class Casos {
    ...
    public int getRepresentateId() {
        return representateId;
    }

    public void setRepresentateId(int representateId) {
        this.representateId = representateId;
    }
    ...
    public void setRepresentante(String reprsentante) {
        this.representante = reprsentante;
    }
